        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mt-16">
            ...
            <div className="text-center space-y-3 p-6 bg-white rounded-2xl shadow-sm border border-slate-100">
              ...
              <a href="mailto:info@penguinbookpublishers.net" className="flex justify-center items-center gap-2 w-full border-2 border-yellow-400 text-yellow-600 font-bold py-3 px-2 rounded-lg hover:bg-yellow-50 transition bg-white text-xs sm:text-sm truncate">
